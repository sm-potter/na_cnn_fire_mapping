...
#bayesian optimzation for more than one band. 
...
#Randomly sample 50% of the elements, if I use everything it is too much data and time
sample_size = int(len(training_names) * 0.5)
...
#combination of model parameters to try
def build_model(hp):
...
directory = '/explore/nobackup/people/spotter5/cnn_mapping/keras_tuner_test_multiband'
...
#save final
tinal.to_csv(os.path.join(directory, 'mtbs_tuned.csv'), index = False)
