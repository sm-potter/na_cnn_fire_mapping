...
callbacks = [tensorflow.keras.callbacks.ModelCheckpoint(
    filepath="/explore/nobackup/people/spotter5/cnn_mapping/nbac_training/models/nbac_mtbs_regularize_50_global_norm_swin",
#     verbose=1,
...
with strategy.scope():
    ...
    model_unet_from_scratch = models.swin_unet_2d((128, 128, 3), filter_num_begin=64, n_labels=num_classes, depth=4, stack_num_down=2, stack_num_up=2,
...
#save final model
model_unet_from_scratch.save("/explore/nobackup/people/spotter5/cnn_mapping/nbac_training/models/nbac_mtbs_regularize_50_global_norm_swin.tf")
...
#save to csv
result.to_csv("/explore/nobackup/people/spotter5/cnn_mapping/nbac_training/nbac_mtbs_regularize_50_global_norm_swin.csv")
