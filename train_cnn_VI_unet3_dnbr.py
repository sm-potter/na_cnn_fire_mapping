...
callbacks = [tensorflow.keras.callbacks.ModelCheckpoint(
    filepath="/explore/nobackup/people/spotter5/cnn_mapping/nbac_training/models/nbac_mtbs_regularize_50_global_norm_unet3_dnbr",
#     verbose=1,
...
with strategy.scope():
    ...
    model_unet_from_scratch = models.unet_3plus_2d((None, None, 1), filter_num_down= [16,32,64,128], #make smaller64, 128, 256, 512,[16, 32, 64, 128]
...
#save final model
model_unet_from_scratch.save("/explore/nobackup/people/spotter5/cnn_mapping/nbac_training/models/nbac_mtbs_regularize_50_global_norm_unet3_dnbr.tf")
...
#save to csv
result.to_csv("/explore/nobackup/people/spotter5/cnn_mapping/nbac_training/nbac_mtbs_regularize_50_global_norm_unet3_dnbr.csv")
