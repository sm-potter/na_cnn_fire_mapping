...
callbacks = [tensorflow.keras.callbacks.ModelCheckpoint(
    filepath="/explore/nobackup/people/spotter5/cnn_mapping/nbac_training/models/nbac_mtbs_regularize_50_global_norm_trans",
#     verbose=1,
...
with strategy.scope():
    ...
    model_unet_from_scratch =  models.transunet_2d((128, 128, 3), filter_num= [16,32,64,128], n_labels=num_classes, stack_num_down=2, stack_num_up=2,
...
#save final model
model_unet_from_scratch.save("/explore/nobackup/people/spotter5/cnn_mapping/nbac_training/models/nbac_mtbs_regularize_50_global_norm_trans.tf")
...
#save to csv
result.to_csv("/explore/nobackup/people/spotter5/cnn_mapping/nbac_training/nbac_mtbs_regularize_50_global_norm_trans.csv")
